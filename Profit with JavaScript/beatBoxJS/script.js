...
let beats = {
    "65": {
        ...
        button: new Button("#00fffe", 65)//Initialized a button class
    },
    "83": {
    ...
    "72": {
        ...
        button: new Button("orange", 72)
    },
    "74": {
        beat: new Beat("./assets/Cymbal Suspended 2.mp3"),
        button: new Button("orange", 74)
    },
    "75": {
...
triggerBeat = (event) => {
    ...
    if (keyCode in beats) {
        ...
        keypress.beat.play();// play fn defined in constructor of class Beat
